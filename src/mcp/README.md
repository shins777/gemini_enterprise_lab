...
* **최종 배포 주소:** `https://korea-realestate-mcp-277211498595.us-central1.run.app/mcp`
* **타겟 지역:** `us-central1`
...
* **엔드포인트 주소:** `https://korea-realestate-mcp-277211498595.us-central1.run.app/mcp`
