...
name: ge-general
description: >-
  Gemini Enterprise의 9가지 핵심 기능(Direct Q&A, Web Grounding, Enterprise Connectors, 등록된 스킬 사용, 전문 서브 에이전트 위임, MCP 서버 연동, 커스텀 스킬 제작, 프로젝트 워크스페이스, 스마트 수신함)을 단계별로 검증하는 핸즈온 랩 실습 가이드 스킬입니다.
version: 1.0.0
---
...
Gemini Enterprise의 9가지 핵심 모듈을 바탕으로 환경 설정, UI 인터페이스 구조, 단계별 시나리오, 실습 프롬프트 및 검증 포인트를 제공합니다.
